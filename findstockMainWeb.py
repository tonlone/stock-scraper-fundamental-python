...
@app.route('/stocks')
def get_stocks():
    #stockList = ["MA", "V", "GOOGL", "MSFT", "PG", "KO", "JNJ", "MCD"]
    ...
    with open(output_recommended_file, 'w') as f:
        ...
        yield "List of Stocks being evaluated(" + str(len(stockList)) + "): " + stock_str + "<br/><br/>"
        yield "isQuarterly: "  + str(isQuarterly) + "<br/><br/>"
        yield "isSkippedDownload: "  + str(isSkippedDownload) + "<br/><br/>"
        yield "isSkippedParsing: "  + str(isSkippedParsing) + "<br/><br/><br/>"
